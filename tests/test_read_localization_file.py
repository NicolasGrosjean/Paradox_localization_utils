...
class TestReadLocalizationFile(unittest.TestCase):
    def test_get_key_and_value(self):
        ...
        self.assertEqual("", key_and_value[4])
        ...
        self.assertEqual("", key_version_and_value[4])
        key_version_value_and_letter = get_key_value_and_version('key:1Z "value"')
        self.assertEqual("key", key_version_value_and_letter[0])
        self.assertEqual("value", key_version_value_and_letter[1])
        self.assertEqual(1, key_version_value_and_letter[2])
        self.assertEqual("Z", key_version_value_and_letter[3])
        self.assertEqual("", key_version_value_and_letter[4])
        ...
        self.assertEqual("", space_key_value[4])
        ...
        self.assertEqual("", value_with_color[4])
        ...
        self.assertEqual("", value_with_two_points[4])
        ...
        self.assertEqual("", value_comment[3])
        self.assertEqual(" #comment", value_comment[4])
        ...
        self.assertEqual("", value_comment_with_two_points[3])
        self.assertEqual(" #comment:a", value_comment_with_two_points[4])
        ...
        self.assertEqual("", value_with_hashtag[4])
        try:

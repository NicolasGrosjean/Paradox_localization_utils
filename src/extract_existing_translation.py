...
def extract_existing_translation(extract_source_dir, extract_dest_dir, target_source_dir, target_dest_dir,
                                 source_lang, dest_lang, source_col_ck2, dest_col_ck2):
